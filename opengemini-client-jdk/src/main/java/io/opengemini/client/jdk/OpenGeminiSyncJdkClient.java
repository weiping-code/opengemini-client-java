...
import io.opengemini.client.common.BaseSyncClient;
...
public class OpenGeminiSyncJdkClient extends BaseSyncClient {

    private final Configuration conf;

    private final HttpClient client;

    public OpenGeminiSyncJdkClient(@NotNull Configuration conf) {
        super(conf);
        this.conf = conf;
     ...
     */
    @Override
    protected QueryResult executePostQuery(Query query) {
        String queryUrl = getQueryUrl(query);
     ...
     */
    @Override
    protected void executeWrite(String database, String lineProtocol) {
